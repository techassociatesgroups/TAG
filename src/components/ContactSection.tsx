...
export function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xwvpnpzp', {
        method: 'POST',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <a
                  href="mailto:info@associatesgroups.in"
            ...
            <p className="text-white/60 text-lg leading-relaxed">
              Have a project in mind? We&apos;re ready to help bring your vision
              to life with cutting-edge design and development solutions.
            </p>
          </motion.div>
          ...
          >
            ...
            <select
              ...
              onChange={handleChange}
              disabled={isSubmitting}
              className="w-full p-4 rounded-lg bg-white/10 border border-white/20 text-white focus:outline-none focus:border-purple-400"
            >
              <option className="text-black">Website Development</option>
              <option className="text-black">UI/UX Design</option>
              <option className="text-black">Digital Marketing & SEO</option>
              <option className="text-black">Brand Identity</option>
              <option className="text-black">E-Commerce Solutions</option>
            </select>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold rounded-lg"
            >
              {submitted
                ? '✓ Message Sent!'
                : isSubmitting
